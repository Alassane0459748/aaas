        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="card h-100 border-0 shadow rounded overflow-hidden">
                    <img class="card-img-top" src="img/news1.jpg" alt="Actualité 1">
                    <div class="card-body p-4">
                        ...
                        <a href="{{ route('actualites') }}" class="btn btn-outline-primary btn-sm">Lire Plus</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="card h-100 border-0 shadow rounded overflow-hidden">
                    <img class="card-img-top" src="img/news2.jpg" alt="Actualité 2">
                    <div class="card-body p-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="card h-100 border-0 shadow rounded overflow-hidden">
                    <img class="card-img-top" src="img/news3.jpg" alt="Actualité 3">
                    <div class="card-body p-4">
