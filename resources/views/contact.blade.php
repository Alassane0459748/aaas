        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow slideInUp" data-wow-delay="0.3s">
                ...
                <form action="{{ route('contact.send') }}" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            <input type="text" name="name" class="form-control border-0 bg-light px-4 py-3 rounded" placeholder="Votre Nom" required>
                        </div>
                        <div class="col-md-6">
                            <input type="email" name="email" class="form-control border-0 bg-light px-4 py-3 rounded" placeholder="Votre Email" required>
                        </div>
                        <div class="col-12">
                            <input type="text" name="subject" class="form-control border-0 bg-light px-4 py-3 rounded" placeholder="Sujet" required>
                        </div>
                        <div class="col-12">
                            <textarea name="message" class="form-control border-0 bg-light px-4 py-3 rounded" rows="5" placeholder="Message" required></textarea>
                        </div>
                        <div class="col-12">
...
<div class="col-lg-6 wow slideInUp" data-wow-delay="0.6s">
    <div class="card border-0 shadow-sm rounded overflow-hidden" style="min-height: 400px;">
        <iframe class="w-100 h-100"
            src="https://www.google.com/maps?q=14.742027,-17.429895&hl=fr&z=16&output=embed"
            frameborder="0"
...
<div class="container-fluid py-5 bg-primary text-white wow fadeInUp" data-wow-delay="0.1s">
    <div class="container text-center">
        <h2 class="mb-4">Suivez-nous sur les réseaux sociaux</h2>
        <p class="mb-4">Restez connectés avec l'Association des Acteurs de l'Assainissement du Sénégal (AAAS)</p>
        <div class="d-flex justify-content-center gap-3">
            <a href="https://x.com/AaasSenegal" target="_blank" rel="noopener noreferrer" 
               class="btn btn-outline-light btn-lg rounded-circle d-flex align-items-center justify-content-center" 
               style="width: 60px; height: 60px;">
                <i class="fab fa-twitter fa-lg"></i>
            </a>
            <a href="https://www.facebook.com/profile.php?id=61582521535450" target="_blank" rel="noopener noreferrer" 
               class="btn btn-outline-light btn-lg rounded-circle d-flex align-items-center justify-content-center" 
               style="width: 60px; height: 60px;">
                <i class="fab fa-facebook-f fa-lg"></i>
            </a>
            <a href="https://www.linkedin.com/in/aaas-senegal-970a9738a/" target="_blank" rel="noopener noreferrer" 
               class="btn btn-outline-light btn-lg rounded-circle d-flex align-items-center justify-content-center" 
               style="width: 60px; height: 60px;">
